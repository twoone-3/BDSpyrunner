...
//		EVENT_INSERT_EX(ItemStack, ItemClass(ev.mItemStack));
//		EVENT_INSERT_EX(Player, EntityClass(ev.mPlayer));
//		EVENT_END;
//		break;
...
//		EVENT_INSERT_EX(BlockInstance, PyBlock(ev.mBlockInstance));
//		EVENT_INSERT_EX(ItemStack, ItemClass(ev.mItemStack));
//		EVENT_INSERT_EX(Player, EntityClass(ev.mPlayer));
//		EVENT_END;
//		break;
...
//		EVENT_INSERT_EX(BlockInstance, PyBlock(ev.mBlockInstance));
//		EVENT_INSERT_EX(Container, PyContainer(ev.mContainer));
//		EVENT_INSERT_EX(Player, EntityClass(ev.mPlayer));
//		EVENT_END;
//		break;
//	case EventCode::onCloseContainer:
...
//		EVENT_INSERT_EX(BlockInstance, PyBlock(ev.mBlockInstance));
//		EVENT_INSERT_EX(Player, EntityClass(ev.mPlayer));
//		EVENT_INSERT_EX(Type, magic_enum::enum_name(ev.mType));
//		EVENT_END;
//		break;
//	case EventCode::onPistonPush:
//		EVENT_BEGIN(PistonPushEvent);
//		EVENT_INSERT_EX(PistonBlockInstance, PyBlock(ev.mPistonBlockInstance));
//		EVENT_INSERT_EX(TargetBlockInstance, PyBlock(ev.mTargetBlockInstance));
//		EVENT_END;
//		break;
//	case EventCode::onHopperSearchItem:
//		EVENT_BEGIN(HopperSearchItemEvent);
//		EVENT_INSERT(DimensionId);
//		EVENT_INSERT_EX(HppperBlock, PyBlock(ev.mHopperBlock));
//		EVENT_INSERT(MinecartPos);
//		EVENT_END;
//		break;
//	case EventCode::onHopperPushOut:
...
//		EVENT_INSERT_EX(NewBlockInstance, PyBlock(ev.mNewBlockInstance));
//		EVENT_INSERT_EX(PreviousBlockInstance, PyBlock(ev.mPreviousBlockInstance));
//		EVENT_END;
//		break;
//	case EventCode::onNpcCmd:
...
//		EVENT_INSERT_EX(Player, EntityClass(ev.mPlayer));
//		EVENT_INSERT_EX(Type, magic_enum::enum_name(ev.mEventType));
//		EVENT_END;
//		break;
//	default:
//		break;
