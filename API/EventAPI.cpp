...
#pragma region Player Events
		...
		case EventCode::onEffectChanged:
			PlayerEffectChangedEvent::subscribe([](const PlayerEffectChangedEvent& ev) {
		...
		case EventCode::onStartDestroyBlock:
			PlayerStartDestroyBlockEvent::subscribe([](const PlayerStartDestroyBlockEvent& ev) {
		...
		case EventCode::onOpenContainer:
			PlayerOpenContainerEvent::subscribe([](const PlayerOpenContainerEvent& ev) {
		...
		case EventCode::onCloseContainer:
			PlayerCloseContainerEvent::subscribe([](const PlayerCloseContainerEvent& ev) {
		...
		case EventCode::onInventoryChange:
			PlayerInventoryChangeEvent::subscribe([](const PlayerInventoryChangeEvent& ev) {
		...
		case EventCode::onUseRespawnAnchor:
			PlayerUseRespawnAnchorEvent::subscribe([](const PlayerUseRespawnAnchorEvent& ev) {
		...
		case EventCode::onOpenContainerScreen:
			PlayerOpenContainerScreenEvent::subscribe([](const PlayerOpenContainerScreenEvent& ev) {
...
#pragma region Entity Events
		...
		case EventCode::onProjectileHitEntity:
			ProjectileHitEntityEvent::subscribe([](const ProjectileHitEntityEvent& ev) {
		...
		case EventCode::onStepOnPressurePlate:
			EntityStepOnPressurePlateEvent::subscribe([](const EntityStepOnPressurePlateEvent& ev) {
...
#pragma region Block Events
		...
		case EventCode::onUseFrameBlock:
			PlayerUseFrameBlockEvent::subscribe([](const PlayerUseFrameBlockEvent& ev) {
