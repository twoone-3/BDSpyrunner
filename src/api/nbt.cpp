...
NBTClass::NBTClass(const NBTClass& other)
    : thiz(other.thiz->copy()), is_reference(false) {}

NBTClass::NBTClass(NBTClass&& other) noexcept
    : thiz(move(other.thiz)), is_reference(other.is_reference) {}

NBTClass::~NBTClass() {
  if (is_reference) thiz.release();
}

NBTClass NBTClass::newEnd() { return EndTag::create(); }

NBTClass NBTClass::newByte(unsigned char value) {
  return ByteTag::create(value);
}

NBTClass NBTClass::newShort(short value) { return ShortTag::create(value); }

NBTClass NBTClass::newInt(int value) { return IntTag::create(value); }

NBTClass NBTClass::newInt64(int64_t value) { return Int64Tag::create(value); }

NBTClass NBTClass::newFloat(float value) { return FloatTag::create(value); }

NBTClass NBTClass::newDouble(double value) { return DoubleTag::create(value); }
...
NBTClass NBTClass::newList() { return ListTag::create(); }
...
NBTClass NBTClass::newIntArray() { return IntArrayTag::create(); }
